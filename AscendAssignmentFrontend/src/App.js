...
import List from "./components/List"; // Add this
import Task from "./components/Task"; // Add this
            ...
            <Container>
              <AnimatePresence mode="wait">
                <Routes>
                  ...
                  <Route path="/list" element={<PageTransition component={List} />} /> 
                  <Route path="/task" element={<PageTransition component={Task} />} />
                </Routes>
              </AnimatePresence>
            </Container>
          </Router>
